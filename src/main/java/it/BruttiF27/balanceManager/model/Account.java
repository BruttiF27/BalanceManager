...
public class Account {
    ...
    // ----- Member methods -----
    public void addMember (Person person) { groupMembers.add(Objects.requireNonNull(person)); }
    public List<Person> getGroupMembers () { return List.copyOf(groupMembers); }

    // ----- Transaction methods -----
    public void addTransaction (Transaction transaction) { transactionList.add(Objects.requireNonNull(transaction)); }
